...
# 程序功能：限制性主坐标轴分析及组间统计
# Functions: Constrained PCoA analysis of samples and groups comparing
# Main steps: 
...
# -o beta/cpcoa_bray # filename prefix for output directory name 
options(warn = -1)
...
if (TRUE){
  ...
  if (opts$output==""){opts$output=paste("beta/cpcoa_",opts$type, sep = "")}
